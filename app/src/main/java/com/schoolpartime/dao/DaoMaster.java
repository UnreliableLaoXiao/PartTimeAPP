...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        SearchTitleDao.createTable(db, ifNotExists);
        UserInfoDao.createTable(db, ifNotExists);
        WorkTypeDao.createTable(db, ifNotExists);
        CityDao.createTable(db, ifNotExists);
        UserCollectDao.createTable(db, ifNotExists);
        RequestWorkDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        SearchTitleDao.dropTable(db, ifExists);
        UserInfoDao.dropTable(db, ifExists);
        WorkTypeDao.dropTable(db, ifExists);
        CityDao.dropTable(db, ifExists);
        UserCollectDao.dropTable(db, ifExists);
        RequestWorkDao.dropTable(db, ifExists);
    }
