...
import com.schoolpartime.schoolpartime.activity.RequestListActivity;
...
import com.schoolpartime.schoolpartime.net.interfacz.MyRequestWorkInfoServer;
...
public class BossRequestPre implements Presenter, View.OnClickListener, XrefershListviewListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {

    private ActivityBossrequestBinding binding;
    ...
    public void attach(ViewDataBinding binding, SuperActivity activity) {
        this.binding = (ActivityBossrequestBinding) binding;
    ...
    private void initData(long userId) {
        HttpRequest.request(HttpRequest.builder().create(MyRequestWorkInfoServer.class).getMyRequestWorkInfo(userId),
                new RequestResult() {
                    @Override
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        bundle.putLong("workid",workInfos.get(position-1).getId());
        (new RequestListActivity()).inToActivity(activity,bundle);
    }
