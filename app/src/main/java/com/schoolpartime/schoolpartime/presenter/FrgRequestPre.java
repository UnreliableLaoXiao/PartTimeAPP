...
public class FrgRequestPre implements Presenter, AdapterView.OnItemClickListener {
    ...
    public void attach(ViewDataBinding binding, SuperActivity activity) {
        this.binding = (FragmentRequestBinding) binding;
    ...
    private void getRequest() {
        HttpRequest.request(HttpRequest.builder().create(GetRequestServer.class).getRequest(SpCommonUtils.getUserId(),0),
                new RequestResult() {
                    @Override
