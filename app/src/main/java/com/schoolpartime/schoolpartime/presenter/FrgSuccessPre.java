...
public class FrgSuccessPre implements Presenter, AdapterView.OnItemClickListener {
    ...
    public void attach(ViewDataBinding binding, SuperActivity activity) {
        this.binding = (FragmentSuccessBinding) binding;
    ...
    private void getRequest() {
        HttpRequest.request(HttpRequest.builder().create(GetRequestServer.class).getRequest(SpCommonUtils.getUserId(),1),
                new RequestResult() {
                    @Override
