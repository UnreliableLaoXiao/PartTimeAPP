package com.schoolpartime.schoolpartime.weiget.myListView;
...
public class XrefershListviewWithScroll extends ListView implements AbsListView.OnScrollListener {
    ...
    public XrefershListviewWithScroll(Context context) {
        super(context);
        initHeardView(context);
    }

    public XrefershListviewWithScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeardView(context);
    }

    public XrefershListviewWithScroll(Context context, AttributeSet attrs, int defStyleAttr) {
